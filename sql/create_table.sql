...
CREATE TABLE `blog_article` (
                                ...
                                `article_cover` varchar(1234) DEFAULT 'https://pic.imgdb.cn/item/65114060c458853aef1f9fa4.jpg' COMMENT '文章缩略图',
...
CREATE TABLE `blog_config` (
                               `id` int NOT NULL AUTO_INCREMENT,
                               `blog_name` varchar(55) DEFAULT '星尘的博客' COMMENT '博客名称',
                               `blog_avatar` varchar(255) DEFAULT 'https://pic.imgdb.cn/item/65114060c458853aef1f9fa4.jpg' COMMENT '博客头像',
